...
class MaintenancesControllerTest < ActionController::TestCase
  ...
  test "should create maintenance" do
    assert_difference('Maintenance.count') do
      post :create, maintenance: { maint_notes: @maintenance.maint_notes, saleterminal_id: @maintenance.saleterminal_id, service_date: @maintenance.service_date }
    end
  ...
  test "should update maintenance" do
    patch :update, id: @maintenance, maintenance: { maint_notes: @maintenance.maint_notes, saleterminal_id: @maintenance.saleterminal_id, service_date: @maintenance.service_date }
    assert_redirected_to maintenance_path(assigns(:maintenance))
  end
