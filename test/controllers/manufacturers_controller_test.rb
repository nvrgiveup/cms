...
class ManufacturersControllerTest < ActionController::TestCase
  ...
  test "should create manufacturer" do
    assert_difference('Manufacturer.count') do
      post :create, manufacturer: { contact_name: @manufacturer.contact_name, contact_phone: @manufacturer.contact_phone, manu_website: @manufacturer.manu_website, manufacturer_name: @manufacturer.manufacturer_name }
    end
  ...
  test "should update manufacturer" do
    patch :update, id: @manufacturer, manufacturer: { contact_name: @manufacturer.contact_name, contact_phone: @manufacturer.contact_phone, manu_website: @manufacturer.manu_website, manufacturer_name: @manufacturer.manufacturer_name }
    assert_redirected_to manufacturer_path(assigns(:manufacturer))
  end
